...
// Decorator pattern => Extend an objects functionality without modifying it.
...
namespace DecoratorPattern
{
    class Program
    {
        ...
        public class Bird : IBird
        {
            ...
            public void Fly()
            {
                Console.WriteLine($"Playing in the sky with weight {Weight}");
            }
        }

        public interface ILizzerd
        {
            void Crawl();
            int Weight { get; set; }
        }

        public class Lizzerd : ILizzerd
        {
            public int Weight { get; set; }
        ...
        // dragon is both bird and lizzerd
        public class Dragon : IBird, ILizzerd
        {
            private Bird bird = new Bird();
            private Lizzerd lizzerd = new Lizzerd();
            private int weight;
        ...
        {
            // Extending StringBuilder's capacity
